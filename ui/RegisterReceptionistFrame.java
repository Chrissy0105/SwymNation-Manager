...
public class RegisterReceptionistFrame extends JFrame {
    ...
    public RegisterReceptionistFrame() {
        UIHelper.setupFrame(this, "Register Receptionist");

        JPanel mainPanel = UIHelper.createMainPanel();
        JLabel header = UIHelper.createHeader("Register Receptionist", UIHelper.TEAL);
        ...
        registerButton = UIHelper.createButton("Register Receptionist", UIHelper.TEAL);
    ...
    private void registerReceptionist() {
        ...
        boolean success = dao.registerUser(name, email, password, "Receptionist");

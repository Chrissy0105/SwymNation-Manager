...
public class RegisterAdminFrame extends JFrame {
    ...
    public RegisterAdminFrame() {
        UIHelper.setupFrame(this, "Register Admin");

        JPanel mainPanel = UIHelper.createMainPanel();
        JLabel header = UIHelper.createHeader("Register Admin", UIHelper.PRIMARY_BLUE);
        ...
        registerButton = UIHelper.createButton("Register Admin", UIHelper.PRIMARY_BLUE);
    ...
    private void registerAdmin() {
        ...
        boolean success = dao.registerUser(name, email, password, "Admin");
